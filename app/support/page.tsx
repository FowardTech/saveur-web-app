  ...
  return (
    <AppShell>
      <div className="mx-auto flex max-w-xl flex-col items-center gap-4 py-16 text-center">
        ...
        <h1 className="text-2xl font-bold text-primary">Live Support</h1>
        <p className="text-sm text-hint">
          In-app live chat support is coming to the web app in a future update. In the meantime, reach us directly
          and we&apos;ll get back to you as soon as we can.
        </p>
        <a
          href="mailto:support@saveurnow.com"
          className="rounded-pill bg-brand px-5 py-2.5 text-sm font-medium text-white transition hover:bg-brand-600"
        >
          Email support@saveurnow.com
        </a>
      </div>
    </AppShell>
  );
