...
const stepCardBg: Record<string, string> = {
    ...
    <RequireAuth>
      <AppShell>
        <div className="mx-auto flex max-w-6xl flex-col gap-8 pb-10">
          ...
          {roadmap && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1 rounded-card border border-border bg-tint-purple p-5">
              ...
              <div className="flex items-center gap-5 rounded-card border border-border bg-tint-mint p-5">
              ...
              <div className="flex flex-col gap-3">
                {roadmap.steps.map((step, index) => (
                  <div
                    key={step.order}
                    className={`animate-card-in flex items-start gap-4 rounded-card border border-border p-4 shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md ${stepCardBg[step.status] ?? "bg-surface-2"}`}
